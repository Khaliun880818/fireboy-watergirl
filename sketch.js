...
function setup() {
    ...
    //bottom right1;
    wall1 = createSprite(100, 650, 140, 70);
    wall1.shapeColor = color(0);
    //bottom right2
    wall2 = createSprite(390, 650, 300, 70);
    wall2.shapeColor = color(0);
     //bottom left
    wall3 = createSprite(645, 650, 70, 70);
    wall3.shapeColor = color(0);
    //count from bottom, line2, right;
    wall4 = createSprite(205, 580, 70, 70);
    wall4.shapeColor = color(100,100,0);
    //line3 right1
    wall5 = createSprite(135, 510, 70, 70);
    wall5.shapeColor = color(0);
    //line3 right2
    wall6 = createSprite(390, 510, 300, 70);
    wall6.shapeColor = color(0);
    //line5 right
    wall7 = createSprite(200, 370, 400, 70);
    wall7.shapeColor = color(0);
    //top right1
    wall8 = createSprite(70, 90, 140, 70);
    wall8.shapeColor = color(0);
    //line7 right;
    wall9 = createSprite(235, 230, 330, 70);
    wall9.shapeColor = color(0);
    //top right2;
    wall10 = createSprite( 340, 90, 260, 70);
    wall10.shapeColor = color(0);
    //top left;
    wall11 = createSprite(540, 125, 140, 140);
    wall11.shapeColor = color(0);
    //line7 left
    wall12 = createSprite(575, 230, 70, 70);
    wall12.shapeColor = color(0);
    //line5 left
    wall13 = createSprite(595, 370, 240, 70);
